...
1. Edit the [environment variable](https://github.com/maxam2017/productive-box/blob/master/.github/workflows/schedule.yml#L17-L18) in `.github/workflows/schedule.yml`:
   ...
   - **GIST_ID:** The ID portion from your gist url: `https://gist.github.com/maxam2017/`**`9842e074b8ee46aef76fd0d493bae0ed`**.<--요거
   - **TIMEZONE:** The timezone of your location, eg. `Asia/Seoul` for Seoul, `America/New_York` for America in New York, etc.
